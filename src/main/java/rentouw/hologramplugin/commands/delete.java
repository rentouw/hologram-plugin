...
public class delete implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (args.length == 1) {
            ...
            String[] data = Sdata.split(","); // 0 = x 1 = y 2 = z 3 = naam 4 = info text
            if (data[4].equals("true")) {
                rentouw.hologram.plugin.file.Deleteholo.Delete(Integer.parseInt(data[0]), Integer.parseInt(data[1]), Integer.parseInt(data[2]), player);
            } else {
